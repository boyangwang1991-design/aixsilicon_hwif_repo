...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `lifecycle_state_pkg.sv` | `rtl/` |
| View B (SV interface) | `lifecycle_state_if.sv` | `rtl/` |
| View C (flat wrapper) | `lifecycle_state_flat_wrapper.sv` | `generated/lifecycle_state/` |
| View D (spec md) | `lifecycle_state_spec.md` | `generated/docs/lifecycle_state/` |
| IP-XACT | `lifecycle_state_busdef.xml` / `lifecycle_state_absdef.xml` | `generated/ipxact/lifecycle_state/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:lifecycle_state
```
