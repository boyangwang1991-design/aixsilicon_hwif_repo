...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `reset_pkg.sv` | `rtl/` |
| View B (SV interface) | `reset_if.sv` | `rtl/` |
| View C (flat wrapper) | `reset_flat_wrapper.sv` | `generated/reset/` |
| View D (spec md) | `reset_spec.md` | `generated/docs/reset/` |
| IP-XACT | `reset_busdef.xml` / `reset_absdef.xml` | `generated/ipxact/reset/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:reset
```
