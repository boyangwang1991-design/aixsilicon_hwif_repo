...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `reg_native_pkg.sv` | `rtl/` |
| View B (SV interface) | `reg_native_if.sv` | `rtl/` |
| View C (flat wrapper) | `reg_native_flat_wrapper.sv` | `generated/reg_native/` |
| View D (spec md) | `reg_native_spec.md` | `generated/docs/reg_native/` |
| IP-XACT | `reg_native_busdef.xml` / `reg_native_absdef.xml` | `generated/ipxact/reg_native/` |
