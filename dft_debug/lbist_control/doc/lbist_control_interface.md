...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `lbist_control_pkg.sv` | `rtl/` |
| View B (SV interface) | `lbist_control_if.sv` | `rtl/` |
| View C (flat wrapper) | `lbist_control_flat_wrapper.sv` | `generated/lbist_control/` |
| View D (spec md) | `lbist_control_spec.md` | `generated/docs/lbist_control/` |
| IP-XACT | `lbist_control_busdef.xml` / `lbist_control_absdef.xml` | `generated/ipxact/lbist_control/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:lbist_control
```
