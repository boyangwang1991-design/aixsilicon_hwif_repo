...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `fifo_push_pop_pkg.sv` | `rtl/` |
| View B (SV interface) | `fifo_push_pop_if.sv` | `rtl/` |
| View C (flat wrapper) | `fifo_push_pop_flat_wrapper.sv` | `generated/fifo_push_pop/` |
| View D (spec md) | `fifo_push_pop_spec.md` | `generated/docs/fifo_push_pop/` |
| IP-XACT | `fifo_push_pop_busdef.xml` / `fifo_push_pop_absdef.xml` | `generated/ipxact/fifo_push_pop/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:fifo_push_pop
```
