...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `status_control_pkg.sv` | `rtl/` |
| View B (SV interface) | `status_control_if.sv` | `rtl/` |
| View C (flat wrapper) | `status_control_flat_wrapper.sv` | `generated/status_control/` |
| View D (spec md) | `status_control_spec.md` | `generated/docs/status_control/` |
| IP-XACT | `status_control_busdef.xml` / `status_control_absdef.xml` | `generated/ipxact/status_control/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:status_control
```
