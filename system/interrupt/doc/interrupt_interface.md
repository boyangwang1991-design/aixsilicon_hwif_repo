...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `interrupt_pkg.sv` | `rtl/` |
| View B (SV interface) | `interrupt_if.sv` | `rtl/` |
| View C (flat wrapper) | `interrupt_flat_wrapper.sv` | `generated/interrupt/` |
| View D (spec md) | `interrupt_spec.md` | `generated/docs/interrupt/` |
| IP-XACT | `interrupt_busdef.xml` / `interrupt_absdef.xml` | `generated/ipxact/interrupt/` |
