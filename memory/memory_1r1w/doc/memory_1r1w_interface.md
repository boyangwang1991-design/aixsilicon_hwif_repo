...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `memory_1r1w_pkg.sv` | `rtl/` |
| View B (SV interface) | `memory_1r1w_if.sv` | `rtl/` |
| View C (flat wrapper) | `memory_1r1w_flat_wrapper.sv` | `generated/memory_1r1w/` |
| View D (spec md) | `memory_1r1w_spec.md` | `generated/docs/memory_1r1w/` |
| IP-XACT | `memory_1r1w_busdef.xml` / `memory_1r1w_absdef.xml` | `generated/ipxact/memory_1r1w/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:memory_1r1w
```
