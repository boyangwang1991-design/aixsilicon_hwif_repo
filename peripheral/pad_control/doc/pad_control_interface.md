...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `pad_control_pkg.sv` | `rtl/` |
| View B (SV interface) | `pad_control_if.sv` | `rtl/` |
| View C (flat wrapper) | `pad_control_flat_wrapper.sv` | `generated/pad_control/` |
| View D (spec md) | `pad_control_spec.md` | `generated/docs/pad_control/` |
| IP-XACT | `pad_control_busdef.xml` / `pad_control_absdef.xml` | `generated/ipxact/pad_control/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:pad_control
```
