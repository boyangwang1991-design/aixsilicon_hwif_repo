...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `spi_pkg.sv` | `rtl/` |
| View B (SV interface) | `spi_if.sv` | `rtl/` |
| View C (flat wrapper) | `spi_flat_wrapper.sv` | `generated/spi/` |
| View D (spec md) | `spi_spec.md` | `generated/docs/spi/` |
| IP-XACT | `spi_busdef.xml` / `spi_absdef.xml` | `generated/ipxact/spi/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:spi
```
