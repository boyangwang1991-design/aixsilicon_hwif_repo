...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `ahb_lite_pkg.sv` | `rtl/` |
| View B (SV interface) | `ahb_lite_if.sv` | `rtl/` |
| View C (flat wrapper) | `ahb_lite_flat_wrapper.sv` | `generated/ahb_lite/` |
| View D (spec md) | `ahb_lite_spec.md` | `generated/docs/ahb_lite/` |
| IP-XACT | `ahb_lite_busdef.xml` / `ahb_lite_absdef.xml` | `generated/ipxact/ahb_lite/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:ahb_lite
```
