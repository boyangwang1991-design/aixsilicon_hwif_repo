...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `i2c_pkg.sv` | `rtl/` |
| View B (SV interface) | `i2c_if.sv` | `rtl/` |
| View C (flat wrapper) | `i2c_flat_wrapper.sv` | `generated/i2c/` |
| View D (spec md) | `i2c_spec.md` | `generated/docs/i2c/` |
| IP-XACT | `i2c_busdef.xml` / `i2c_absdef.xml` | `generated/ipxact/i2c/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:i2c
```
