...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `hac_mem_pkg.sv` | `rtl/` |
| View B (SV interface) | `hac_mem_if.sv` | `rtl/` |
| View C (flat wrapper) | `hac_mem_flat_wrapper.sv` | `generated/hac_mem/` |
| View D (spec md) | `hac_mem_spec.md` | `generated/docs/hac_mem/` |
| IP-XACT | `hac_mem_busdef.xml` / `hac_mem_absdef.xml` | `generated/ipxact/hac_mem/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:hac_mem
```
