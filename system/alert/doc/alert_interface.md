...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `alert_pkg.sv` | `rtl/` |
| View B (SV interface) | `alert_if.sv` | `rtl/` |
| View C (flat wrapper) | `alert_flat_wrapper.sv` | `generated/alert/` |
| View D (spec md) | `alert_spec.md` | `generated/docs/alert/` |
| IP-XACT | `alert_busdef.xml` / `alert_absdef.xml` | `generated/ipxact/alert/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:alert
```
