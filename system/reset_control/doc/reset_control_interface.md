...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `reset_control_pkg.sv` | `rtl/` |
| View B (SV interface) | `reset_control_if.sv` | `rtl/` |
| View C (flat wrapper) | `reset_control_flat_wrapper.sv` | `generated/reset_control/` |
| View D (spec md) | `reset_control_spec.md` | `generated/docs/reset_control/` |
| IP-XACT | `reset_control_busdef.xml` / `reset_control_absdef.xml` | `generated/ipxact/reset_control/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:reset_control
```
