...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `performance_event_pkg.sv` | `rtl/` |
| View B (SV interface) | `performance_event_if.sv` | `rtl/` |
| View C (flat wrapper) | `performance_event_flat_wrapper.sv` | `generated/performance_event/` |
| View D (spec md) | `performance_event_spec.md` | `generated/docs/performance_event/` |
| IP-XACT | `performance_event_busdef.xml` / `performance_event_absdef.xml` | `generated/ipxact/performance_event/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:performance_event
```
