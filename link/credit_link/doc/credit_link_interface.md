...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `credit_link_pkg.sv` | `rtl/` |
| View B (SV interface) | `credit_link_if.sv` | `rtl/` |
| View C (flat wrapper) | `credit_link_flat_wrapper.sv` | `generated/credit_link/` |
| View D (spec md) | `credit_link_spec.md` | `generated/docs/credit_link/` |
| IP-XACT | `credit_link_busdef.xml` / `credit_link_absdef.xml` | `generated/ipxact/credit_link/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:credit_link
```
