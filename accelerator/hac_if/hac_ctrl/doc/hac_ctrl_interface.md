...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `hac_ctrl_pkg.sv` | `rtl/` |
| View B (SV interface) | `hac_ctrl_if.sv` | `rtl/` |
| View C (flat wrapper) | `hac_ctrl_flat_wrapper.sv` | `generated/hac_ctrl/` |
| View D (spec md) | `hac_ctrl_spec.md` | `generated/docs/hac_ctrl/` |
| IP-XACT | `hac_ctrl_busdef.xml` / `hac_ctrl_absdef.xml` | `generated/ipxact/hac_ctrl/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:hac_ctrl
```
