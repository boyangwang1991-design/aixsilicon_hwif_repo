...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `hac_lmem_pkg.sv` | `rtl/` |
| View B (SV interface) | `hac_lmem_if.sv` | `rtl/` |
| View C (flat wrapper) | `hac_lmem_flat_wrapper.sv` | `generated/hac_lmem/` |
| View D (spec md) | `hac_lmem_spec.md` | `generated/docs/hac_lmem/` |
| IP-XACT | `hac_lmem_busdef.xml` / `hac_lmem_absdef.xml` | `generated/ipxact/hac_lmem/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:hac_lmem
```
