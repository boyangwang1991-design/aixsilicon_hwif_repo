...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `noc_flit_pkg.sv` | `rtl/` |
| View B (SV interface) | `noc_flit_if.sv` | `rtl/` |
| View C (flat wrapper) | `noc_flit_flat_wrapper.sv` | `generated/noc_flit/` |
| View D (spec md) | `noc_flit_spec.md` | `generated/docs/noc_flit/` |
| IP-XACT | `noc_flit_busdef.xml` / `noc_flit_absdef.xml` | `generated/ipxact/noc_flit/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:noc_flit
```
