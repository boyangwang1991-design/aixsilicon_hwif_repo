...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `hac_mgmt_pkg.sv` | `rtl/` |
| View B (SV interface) | `hac_mgmt_if.sv` | `rtl/` |
| View C (flat wrapper) | `hac_mgmt_flat_wrapper.sv` | `generated/hac_mgmt/` |
| View D (spec md) | `hac_mgmt_spec.md` | `generated/docs/hac_mgmt/` |
| IP-XACT | `hac_mgmt_busdef.xml` / `hac_mgmt_absdef.xml` | `generated/ipxact/hac_mgmt/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:hac_mgmt
```
