...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `tilelink_ul_pkg.sv` | `rtl/` |
| View B (SV interface) | `tilelink_ul_if.sv` | `rtl/` |
| View C (flat wrapper) | `tilelink_ul_flat_wrapper.sv` | `generated/tilelink_ul/` |
| View D (spec md) | `tilelink_ul_spec.md` | `generated/docs/tilelink_ul/` |
| IP-XACT | `tilelink_ul_busdef.xml` / `tilelink_ul_absdef.xml` | `generated/ipxact/tilelink_ul/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:tilelink_ul
```
