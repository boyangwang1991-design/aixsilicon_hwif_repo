...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `cache_maintenance_pkg.sv` | `rtl/` |
| View B (SV interface) | `cache_maintenance_if.sv` | `rtl/` |
| View C (flat wrapper) | `cache_maintenance_flat_wrapper.sv` | `generated/cache_maintenance/` |
| View D (spec md) | `cache_maintenance_spec.md` | `generated/docs/cache_maintenance/` |
| IP-XACT | `cache_maintenance_busdef.xml` / `cache_maintenance_absdef.xml` | `generated/ipxact/cache_maintenance/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:cache_maintenance
```
