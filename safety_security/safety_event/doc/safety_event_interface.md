...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `safety_event_pkg.sv` | `rtl/` |
| View B (SV interface) | `safety_event_if.sv` | `rtl/` |
| View C (flat wrapper) | `safety_event_flat_wrapper.sv` | `generated/safety_event/` |
| View D (spec md) | `safety_event_spec.md` | `generated/docs/safety_event/` |
| IP-XACT | `safety_event_busdef.xml` / `safety_event_absdef.xml` | `generated/ipxact/safety_event/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:safety_event
```
