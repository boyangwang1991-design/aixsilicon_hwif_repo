...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `clock_pkg.sv` | `rtl/` |
| View B (SV interface) | `clock_if.sv` | `rtl/` |
| View C (flat wrapper) | `clock_flat_wrapper.sv` | `generated/clock/` |
| View D (spec md) | `clock_spec.md` | `generated/docs/clock/` |
| IP-XACT | `clock_busdef.xml` / `clock_absdef.xml` | `generated/ipxact/clock/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:clock
```
