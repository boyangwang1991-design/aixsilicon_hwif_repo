...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `hac_stream_pkg.sv` | `rtl/` |
| View B (SV interface) | `hac_stream_if.sv` | `rtl/` |
| View C (flat wrapper) | `hac_stream_flat_wrapper.sv` | `generated/hac_stream/` |
| View D (spec md) | `hac_stream_spec.md` | `generated/docs/hac_stream/` |
| IP-XACT | `hac_stream_busdef.xml` / `hac_stream_absdef.xml` | `generated/ipxact/hac_stream/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:hac_stream
```
