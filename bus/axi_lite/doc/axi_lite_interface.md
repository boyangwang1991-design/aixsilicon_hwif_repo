...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `axi_lite_pkg.sv` | `rtl/` |
| View B (SV interface) | `axi_lite_if.sv` | `rtl/` |
| View C (flat wrapper) | `axi_lite_flat_wrapper.sv` | `generated/axi_lite/` |
| View D (spec md) | `axi_lite_spec.md` | `generated/docs/axi_lite/` |
| IP-XACT | `axi_lite_busdef.xml` / `axi_lite_absdef.xml` | `generated/ipxact/axi_lite/` |
