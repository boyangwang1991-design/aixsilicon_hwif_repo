...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `lockstep_compare_pkg.sv` | `rtl/` |
| View B (SV interface) | `lockstep_compare_if.sv` | `rtl/` |
| View C (flat wrapper) | `lockstep_compare_flat_wrapper.sv` | `generated/lockstep_compare/` |
| View D (spec md) | `lockstep_compare_spec.md` | `generated/docs/lockstep_compare/` |
| IP-XACT | `lockstep_compare_busdef.xml` / `lockstep_compare_absdef.xml` | `generated/ipxact/lockstep_compare/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:lockstep_compare
```
