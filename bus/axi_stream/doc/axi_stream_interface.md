...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `axi_stream_pkg.sv` | `rtl/` |
| View B (SV interface) | `axi_stream_if.sv` | `rtl/` |
| View C (flat wrapper) | `axi_stream_flat_wrapper.sv` | `generated/axi_stream/` |
| View D (spec md) | `axi_stream_spec.md` | `generated/docs/axi_stream/` |
| IP-XACT | `axi_stream_busdef.xml` / `axi_stream_absdef.xml` | `generated/ipxact/axi_stream/` |
