...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `packet_stream_pkg.sv` | `rtl/` |
| View B (SV interface) | `packet_stream_if.sv` | `rtl/` |
| View C (flat wrapper) | `packet_stream_flat_wrapper.sv` | `generated/packet_stream/` |
| View D (spec md) | `packet_stream_spec.md` | `generated/docs/packet_stream/` |
| IP-XACT | `packet_stream_busdef.xml` / `packet_stream_absdef.xml` | `generated/ipxact/packet_stream/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:packet_stream
```
