...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `error_report_pkg.sv` | `rtl/` |
| View B (SV interface) | `error_report_if.sv` | `rtl/` |
| View C (flat wrapper) | `error_report_flat_wrapper.sv` | `generated/error_report/` |
| View D (spec md) | `error_report_spec.md` | `generated/docs/error_report/` |
| IP-XACT | `error_report_busdef.xml` / `error_report_absdef.xml` | `generated/ipxact/error_report/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:error_report
```
