...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `uart_pkg.sv` | `rtl/` |
| View B (SV interface) | `uart_if.sv` | `rtl/` |
| View C (flat wrapper) | `uart_flat_wrapper.sv` | `generated/uart/` |
| View D (spec md) | `uart_spec.md` | `generated/docs/uart/` |
| IP-XACT | `uart_busdef.xml` / `uart_absdef.xml` | `generated/ipxact/uart/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:uart
```
