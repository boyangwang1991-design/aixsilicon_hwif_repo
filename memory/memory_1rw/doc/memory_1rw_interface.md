...
| 视图 | 类型 | 位置 |
|---|---|---|
| View A (packed struct) | `memory_1rw_pkg.sv` | `rtl/` |
| View B (SV interface) | `memory_1rw_if.sv` | `rtl/` |
| View C (flat wrapper) | `memory_1rw_flat_wrapper.sv` | `generated/memory_1rw/` |
| View D (spec md) | `memory_1rw_spec.md` | `generated/docs/memory_1rw/` |
| IP-XACT | `memory_1rw_busdef.xml` / `memory_1rw_absdef.xml` | `generated/ipxact/memory_1rw/` |
...
```text
aixsilicon:interface:common → aixsilicon:interface:memory_1rw
```
